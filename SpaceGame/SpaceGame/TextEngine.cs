 ...
 */
 ...
 //Code written by Shawn75 here: http://www.opentk.com/node/3730
...
namespace Core.Graphics
{
	...
	public class TextEngine : Component
	{
        ...
        /// </summary> 
            ...
            public TextEngine(int width, int height)
            {
                if (width <= 0)
            ...
            ~TextEngine()
            {
                Console.WriteLine("[Warning] Resource leaked: {0}.", typeof(TextEngine));
            }
